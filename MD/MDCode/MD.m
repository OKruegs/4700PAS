...
if nAtoms2  
    V2_2 = (Vx(Pty2in).*Vx(Pty2in) + Vy(Pty2in).*Vy(Pty2in)); % Calculate V2 for Mass2
else
    V2_2 = 0;
end
...
while t < TStop
    ...
    % Calculate forces using the modified GetForces function
    GetForces(PhiCutoff, LJEpsilon, LJSigma);
