...
AddRectAtomicArray(10, 5, 0, 0, 0, 0, 0, T, 0);
% vy0 = -sqrt(0.02*Ep/Mass1);
% AddRectAtomicArray(4,4,0,12*AtomSpacing,0,vy0,0,T,1);
Ep = 2;
% AddParticleStream(4, -0.5, 10, -pi / 2, 1, Ep * C.q_0, 5);
% 
% AddParticleStream(6, 0.5, 10, -pi / 2, 2, Ep * C.q_0, 5);

AddParticleStream(10, -1, 10, -pi / 2, 2, Ep * C.q_0, 2);

AddParticleStream(5, 0, 10, -pi / 2, 1, 1 * C.q_0, 5);
