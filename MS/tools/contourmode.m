...
%b) 
%figure 1: TE - Transverse Electric mode
%Hy dominant
%light is confined in the ridge
%Electric field is orientated in the y-direction

%figure 2: TM - Transverse Magnetic mode
%Hx Dominant 
%light confined in the ridge
%Magnetic field is orientated in the x-direction

%d)
%I believe that contour is better for this due to the fact that we are
%viewing these modes in 2D. Contour allows us a clearer view of each data
%level line and allows us to see the ridge much clearer.

%Surf is nice to see a fully continous plot though
